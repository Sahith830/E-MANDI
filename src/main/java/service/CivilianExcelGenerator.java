...
public class CivilianExcelGenerator 
{
	String filename="C:\\Users\\YASHASREE\\eclipse-workspace\\mandi\\SHEETS\\CivilianExcel.xls";
	int i=1;
	...
	public HSSFWorkbook  excelGenerate(Register register, List<Register> list) throws IOException 
	{
		if(checkFile.exists()) 
		{
			try 
			{
				...
				Sheet sheet= workbook.getSheet("CivilianDetails");
		...
		else 
		{
			try 
			{
				...
				HSSFSheet  sheet= (HSSFSheet) workbook.createSheet("CivilianDetails");
